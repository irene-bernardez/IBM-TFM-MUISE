...
#include "qrcode.h"
#include "qr.h"  // Nueva inclusión para las declaraciones
...
/* Nueva función para iniciar la provisión */
void wifi_prov_init(void)
{
    ...
    /* Wait for Wi-Fi connection (esto puede manejarse en app_main.c si es necesario) */
    xEventGroupWaitBits(wifi_event_group, WIFI_CONNECTED_EVENT, true, true, portMAX_DELAY);
}

/* Función para de-initializar (opcional) */
